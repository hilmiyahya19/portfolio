...
export default function About() {
  ...
  const writtenDate = 'October 13, 2025'
  ...
  return (
    <section className="px-6 py-20 md:px-12 lg:px-20 xl:px-32 flex flex-col items-center text-center text-gray-200">
      ...
      >
        ...
        >
          I am a Computer Science graduate with an interest in full stack web development. I work with technologies such as React and Next.js for the frontend, and Node.js with Express.js for the backend. I use JavaScript and TypeScript as my main programming languages, and have experience managing data with MySQL and MongoDB. I am continuously learning and exploring new technologies to strengthen my skills and develop as a full stack web developer.
        </motion.p>
